                    ...
                    {services.map((service, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group relative bg-[#121218] border border-white/5 rounded-2xl p-10 flex flex-col items-center justify-center text-center transition-all duration-300 hover:border-[#C6A15B]/50 hover:bg-white/[0.02] cursor-pointer"
                            >
                                <div className="mb-6 w-14 h-14 rounded-full border border-white/20 flex items-center justify-center text-[#C6A15B]/70 group-hover:text-[#C6A15B] group-hover:border-[#C6A15B]/60 transition-all duration-300">
